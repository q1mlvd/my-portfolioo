            ...
            {posts.map((post, i) => {
              ...
              return (
                <motion.a
                  ...
                  whileHover={{ y: -4 }}
                  className="group block p-6 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 hover:border-blue-500/30 transition-all duration-300 cursor-pointer"
                >
